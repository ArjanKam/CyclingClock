...
if __name__ == "__main__":
    ...
    changer1    = RoterySwitch( 6,  7, prevValue, nextValue,  5, pressed, False)
    changer2    = RoterySwitch( 9, 10, prevValue, nextValue,  8, pressed, False)
    changer3    = RoterySwitch(12, 13, prevValue, nextValue, 11, pressed, False)
